    ...
    <div>
      {isMobile === true ? (
        <div className="flex flex-col justify-center items-center gap-5">
          <div className="flex flex-col justify-center items-center gap-5">
            <Card
              className={`bg-white w-[20rem] h-[20rem] flex flex-col 
            ...
            >
              ...
              <div className="flex flex-col text-center">
                ...
                <span className="text-blue font-bold">
                  60/<span className="">days</span>
                </span>
              </div>
              <Button className={`bg-blue text-white rounded-md p-2`}>
                Get Started
              </Button>
            </Card>
            <Card
              className={`bg-black w-[20rem] h-[20rem] flex flex-col 
            justify-center items-center shadow-lg shadow-slate-50 gap-5 rounded-lg`}
            >
