...
export const Features = () => {
  ...
  return (
    <div>
      ...
      <Card className="w-[30rem] h-[20rem] flex flex-col justify-center items-center bg-black">
        <Image
      ...
      <Card className="bg-blue w-[30rem] h-[20rem] flex flex-col justify-center items-center">
        <Image
      ...
      <Card
        variant="bg-white"
        className="w-[30rem] h-[20rem] flex flex-col justify-center items-center"
      >
        <Image
  ...
  </div>):(<div className={`flex justify-center items-center -translate-y-[3rem]`}>
