    ...
    return (
        <div>
            <section className='w-full h-full  px-8 py-6'>
                ...
                {/* second section */}
                <div className="flex gap-3 mt-3 h-2/3 pb-10">
                    <div className="py-3 mt-3 h-full bg-gray-200 pb-10 rounded-lg" style={{ width: '67.5%' }}>
                    ...
                    <div className="py-3 mt-3 h-full bg-gray-200 rounded-lg" style={{ width: '32.5%' }}>
