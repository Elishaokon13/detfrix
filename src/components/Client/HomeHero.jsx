  ...
  return (
    <div className="relative overflow-hidden font-[roboto] bg-gradient-to-b from-blue-400">
      <div className="mx-auto max-w-7xl">
        <div className="relative z-10 bg-blue pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32">
          <svg
          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 bg-gradient-to-b from-blue-400 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">The World's<br/> Financial Markets</span>{' '}
                <span className="block text-blue-600 xl:inline">Trading Platform</span>
              </h1>
      ...
      <div className="lg:absolute lg:inset-y-0 bg-gradient-to-r from-blue-500 lg:right-0 lg:w-1/2">
        <img
          className="h-26 w-full object-cover sm:h-72 md:h-96 lg:h-full lg:w-full"
