...
function AboutUs() {
    return (
        <>
            <Navbar />
            <div className="md:mx-auto md:container font-[roboto] px-4">
                <div className="pt-10 md:pt-40">
                    <div className="container mx-auto">
                        <div className="flex flex-wrap items-center pb-12">
                            <div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
                                <div className="py-2 text-color">
                                    <h1 className="text-2xl lg:text-6xl md:leading-snug tracking-tighter f-f-l font-bold text-blue-500">Boost adoption of product and services</h1>
                    ...
                    <div className="mx-auto">
                        <div className="flex flex-wrap flex-row-reverse items-center">
                            <div className="md:w-1/2 lg:w-2/3 w-full lg:pl-20 md:pl-10 sm:pl-0 pl-0">
                                <div className="py-2 text-color">
                                    <h1 className="text-2xl lg:text-6xl tracking-tighter md:leading-snug f-f-l font-bold text-blue-500">Easily manage sales through our invoicing system</h1>
